...
function DocsContainer() {
    return (react_1.default.createElement("div", { className: 'github' },
        ...
        react_1.default.createElement("div", { className: 'markdown-container' },
            ...
            react_1.default.createElement("pre", null,
                react_1.default.createElement("div", { className: 'code' },
                    react_1.default.createElement("code", null,
                        react_1.default.createElement("span", { className: 'hljs-keyword' }, "const"),
                        " Ember =",
                        ' ',
                        react_1.default.createElement("span", { className: 'hljs-keyword' }, "new"),
            ...
            react_1.default.createElement("pre", null,
                react_1.default.createElement("div", { className: 'code' },
                    react_1.default.createElement("code", { className: 'lang-javascript' },
                        "app.use(",
                        react_1.default.createElement("span", { className: 'hljs-string' }, "'/graphql'"),
                        ", Ember.handleQuery,",
                        ' ',
                        react_1.default.createElement("span", { className: 'hljs-function' },
                            react_1.default.createElement("span", { className: 'hljs-params' }, "(req, res)"),
                            " =>"),
                        ' ',
                        '{',
                        '\n',
                        '  ',
                        "res.status(",
                        react_1.default.createElement("span", { className: 'hljs-number' }, "202"),
            ...
            react_1.default.createElement("pre", null,
                react_1.default.createElement("div", { className: 'code' },
                    react_1.default.createElement("code", { className: 'lang-javascript' },
                        "app.use(",
                        react_1.default.createElement("span", { className: 'hljs-string' }, "'/clearCache'"),
                        ", Ember.clearCache,",
                        ' ',
                        react_1.default.createElement("span", { className: 'hljs-function' },
                            react_1.default.createElement("span", { className: 'hljs-params' }, "(req, res)"),
            ...
            react_1.default.createElement("pre", null,
                react_1.default.createElement("div", { className: 'code' },
                    react_1.default.createElement("code", { className: 'lang-javascript' },
                        ...
                        "setInterval(",
                        react_1.default.createElement("span", { className: 'hljs-function' },
                            react_1.default.createElement("span", { className: 'hljs-params' }, "()"),
                            " =>"),
                        ' ',
                        '{',
                        '\n',
                        ...
                        '}',
                        ", ",
                        react_1.default.createElement("span", { className: 'hljs-number' }, "3000"),
                        ");",
                        '\n'))),
            ...
            react_1.default.createElement("br", null),
            react_1.default.createElement("p", null,
                react_1.default.createElement("a", { href: 'https://github.com/Cristian-DeLosRios', className: 'git-link' }, "Cristian De Los Rios"),
                ' ',
                "|",
                ' ',
                react_1.default.createElement("a", { href: 'https://github.com/manjunathap85', className: 'git-link' }, "Manjunath Ajjappa Pattanashetty"),
                ' ',
                "|",
                ' ',
                react_1.default.createElement("a", { href: 'https://github.com/mikemasatsugu', className: 'git-link' }, "Mike Masatsugu"),
                ' ',
                "|",
                ' ',
                react_1.default.createElement("a", { href: 'https://github.com/rammarimuthu', className: 'git-link' }, "Ram Marimuthu"),
                ' ',
                "|",
                ' ',
                react_1.default.createElement("a", { href: 'https://github.com/tylerpohn', className: 'git-link' }, "Tyler Pohn")))));
}
